...
/** Nút kim loại lỏng (port từ bộ shader-button, thêm width/icon tuỳ chỉnh). */
      ...
      <div style={{ perspective: "1000px", perspectiveOrigin: "50% 50%" }}>
        ...
        >
          ...
          >
            {viewMode === "icon" && (
              icon ?? (
                <Sparkles size={16} style={{ color: "#8a8a8a", filter: "drop-shadow(0px 1px 2px rgba(0,0,0,0.5))" }} />
              )
            )}
            {viewMode === "text" && (
              <span
          ...
          <div
            style={{
              ...
              width: `${dimensions.width}px`, height: `${dimensions.height}px`,
              transformStyle: "preserve-3d", transition: spring,
              transform: `translateZ(10px) ${isPressed ? "translateY(1px) scale(0.98)" : ""}`, zIndex: 20,
            }}
          >
            <div
              style={{
          ...
          <div
            style={{
              ...
              width: `${dimensions.width}px`, height: `${dimensions.height}px`,
              transformStyle: "preserve-3d", transition: spring,
              transform: `translateZ(0px) ${isPressed ? "translateY(1px) scale(0.98)" : ""}`, zIndex: 10,
            }}
          >
            <div
              style={{
          ...
          <button
            ...
            style={{
              ...
              transition: spring, overflow: "hidden", borderRadius: "100px",
            }}
            aria-label={label}
          >
            {ripples.map((ripple) => (
